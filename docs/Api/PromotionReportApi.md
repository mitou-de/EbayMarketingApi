# EbayMarketingApi\PromotionReportApi
...
> \EbayMarketingApi\Model\PromotionsReportPagedCollection getPromotionReports($marketplace_id, $limit, $offset, $promotion_status, $promotion_type, $q)
...
$apiInstance = new EbayMarketingApi\Api\PromotionReportApi(
...
[**\EbayMarketingApi\Model\PromotionsReportPagedCollection**](../Model/PromotionsReportPagedCollection.md)
