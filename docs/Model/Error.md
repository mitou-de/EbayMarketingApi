...
**parameters** | [**\EbayMarketingApi\Model\ErrorParameter[]**](ErrorParameter.md) | An array that contains contextual information about the error or warning. The list often includes the parameter or input fields that triggered the warning or error condition. | [optional] 
