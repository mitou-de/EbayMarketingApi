...
class SelectionRule implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'max_price' => '\EbayMarketingApi\Model\Amount',
        'min_price' => '\EbayMarketingApi\Model\Amount'
    ];
     ...
     * Sets category_scope
     *
     * @param string|null $category_scope Indicates the source of the category ID; eBay or seller's store. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/marketing/types/CategoryScopeEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $listing_condition_ids The ID of the listing's condition. Valid values: 1000 = New 2000 = Manufacturer refurbished 2500 = Seller refurbished 3000 = Used/Like new/Pre owned
     *
     * @return $this
     */
     ...
     * Sets max_price
     *
     * @param \EbayMarketingApi\Model\Amount|null $max_price max_price
     *
     * @return $this
     */
     ...
     * Sets min_price
     *
     * @param \EbayMarketingApi\Model\Amount|null $min_price min_price
     *
     * @return $this
     */
