...
class InventoryReference implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string|null $inventory_reference_id Required if if you supply an inventoryReferenceType The seller's inventory reference ID for a listing. An inventory reference is either the ID of a single listing or the ID of the parent of an item group listing (a multi-variation listing, such as a shirt that is available in multiple sizes and colors).
     *
     * @return $this
     */
     ...
     *
     * @param string|null $inventory_reference_type Required if if you supply an inventoryReferenceId Indicates the type of the inventoryReferenceId. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/marketing/types/InventoryReferenceTypeEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
