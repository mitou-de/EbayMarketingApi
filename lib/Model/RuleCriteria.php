 ...
 *
 * @category Class
 * @description This type defines the fields for a set of inventory selection rules. Required: When inventoryCriterionType is set to INVENTORY_BY_RULE.
 * @package  EbayMarketingApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class RuleCriteria implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'exclude_inventory_items' => '\EbayMarketingApi\Model\InventoryItem[]',
        'exclude_listing_ids' => 'string[]',
        'markup_inventory_items' => '\EbayMarketingApi\Model\InventoryItem[]',
     ...
     *
     * @param \EbayMarketingApi\Model\InventoryItem[]|null $exclude_inventory_items A list of seller inventory reference IDs to exclude from the promotion. Note: The request can have either excludeInventoryItems or excludeListingIds but not both. Maximum: 100 parent items Maximum SKU or custom label length: 50 characters
     *
     * @return $this
     */
     ...
     *
     * @param \EbayMarketingApi\Model\InventoryItem[]|null $markup_inventory_items A list of SKUs to remove from a markdown promotion. The listed SKUs are 'marked up' to their standard price after being part of the markdown promotion.
     *
     * @return $this
     */
     ...
     *
     * @param \EbayMarketingApi\Model\SelectionRule[]|null $selection_rules Required if: inventoryCriterionType is set to INVENTORY_BY_RULE. The container for the rules that select the items to include in a promotion.
     *
     * @return $this
     */
