...
class CreateAdsByInventoryReferenceResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'ads' => '\EbayMarketingApi\Model\AdReference[]',
     ...
     * Gets ads
     *
     * @return \EbayMarketingApi\Model\AdReference[]|null
     */
     ...
     * Sets ads
     *
     * @param \EbayMarketingApi\Model\AdReference[]|null $ads A list of ad IDs (based on their inventory reference IDs) and the URIs that point to them.
     *
     * @return $this
     */
     ...
     * Sets errors
     *
     * @param \EbayMarketingApi\Model\Error[]|null $errors An array of errors or warnings associated with the create-ads request.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $inventory_reference_id The seller's inventory reference ID that's associated with the ad.
     *
     * @return $this
     */
