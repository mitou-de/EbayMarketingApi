...
class MetricMetadata implements ModelInterface, ArrayAccess
{
     ...
     * Sets data_type
     *
     * @param string|null $data_type The data type of the returned metric value. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/marketing/types/DataTypeEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
