...
class ReportTask implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'date_from' => 'string',
        'date_to' => 'string',
        'dimensions' => '\EbayMarketingApi\Model\Dimension[]',
        'inventory_references' => '\EbayMarketingApi\Model\InventoryReference[]',
        'listing_ids' => 'string[]',
     ...
     * Sets date_from
     *
     * @param string|null $date_from The date and time defining the start of the timespan covered by the report. For display purposes, convert this time into the local time of the seller. Valid format (UTC): yyyy-MM-ddThh:mm:ss.sssZ
     *
     * @return $this
     */
     ...
     * Sets date_to
     *
     * @param string|null $date_to The date and time defining the end of the report timespan. For display purposes, convert this time into the local time of the seller. Valid format (UTC): yyyy-MM-ddThh:mm:ss.sssZ
     *
     * @return $this
     */
     ...
     * Gets dimensions
     *
     * @return \EbayMarketingApi\Model\Dimension[]|null
     */
     ...
     * Sets dimensions
     *
     * @param \EbayMarketingApi\Model\Dimension[]|null $dimensions A list containing the dimension in the report.
     *
     * @return $this
     */
     ...
     *
     * @return \EbayMarketingApi\Model\InventoryReference[]|null
     */
     ...
     *
     * @param \EbayMarketingApi\Model\InventoryReference[]|null $inventory_references A list of the seller's inventory reference IDs to be included in the report. An inventory reference ID can be either a seller-defined SKU value or an inventoryItemGroupKey. An inventoryItemGroupKey is seller-defined ID for an inventory item group (a multiple-variation listing), and is created and used by the Inventory API.
     *
     * @return $this
     */
     ...
     * Sets listing_ids
     *
     * @param string[]|null $listing_ids A list of the listing IDs to be included in the report. A listing ID is an eBay-assigned ID that's generated when a listing is created. Note: This field accepts both a listingId, as generated by the Inventory API, and an itemId as used in the eBay Traditional API set (e.g., the Trading and Finding APIs).
     *
     * @return $this
     */
     ...
     * Sets marketplace_id
     *
     * @param string|null $marketplace_id The ID of the eBay marketplace used by the report task. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/marketing/types/MarketplaceIdEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     *
     * @param string|null $report_expiration_date The date after which the report is no longer be available. Reports are available for 30 days and you cannot download a report after it has expired. For display purposes, convert this time into the local time of the seller. Format (UTC): yyyy-MM-ddThh:mm:ss.sssZ
     *
     * @return $this
     */
     ...
     * Sets report_format
     *
     * @param string|null $report_format Indicates the format of the report. Currently, only TSV_GZIP is supported. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/marketing/types/ReportFormatEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     *
     * @param string|null $report_task_completion_date The date the report task completed the report generation. For display purposes, convert this time into the local time of the seller. Format (UTC): yyyy-MM-ddThh:mm:ss.sssZ
     *
     * @return $this
     */
     ...
     *
     * @param string|null $report_task_creation_date The date the report task was created. For display purposes, convert this time into the local time of the seller. Format (UTC): yyyy-MM-ddThh:mm:ss.sssZ
     *
     * @return $this
     */
     ...
     *
     * @param string|null $report_task_expected_completion_date The date the report task is expected to complete the report generation. For display purposes, convert this time into the local time of the seller. Format (UTC): yyyy-MM-ddThh:mm:ss.sssZ
     *
     * @return $this
     */
     ...
     *
     * @param string|null $report_task_status Indicates the current state of the report task. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/marketing/types/TaskStatusEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     * Sets report_type
     *
     * @param string|null $report_type Indicates type of report associated with the report task. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/marketing/types/ReportTypeEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
