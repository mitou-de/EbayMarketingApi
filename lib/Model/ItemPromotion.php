...
class ItemPromotion implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'discount_rules' => '\EbayMarketingApi\Model\DiscountRule[]',
        'end_date' => 'string',
     ...
     *
     * @param bool|null $apply_discount_to_single_item_only This flag is only relevant in volume pricing promotions (VOLUME_DISCOUNT). If set to true, the discount is applied only when the buyer purchases multiple quantities of a single item in the promotion. Otherwise, the promotional discount applies to multiple quantities of any items in the promotion. Note that this flag is not relevant if the inventoryCriterion container identifies a single listing ID for the promotion.
     *
     * @return $this
     */
     ...
     * Gets discount_rules
     *
     * @return \EbayMarketingApi\Model\DiscountRule[]|null
     */
     ...
     *
     * @param string|null $promotion_status The current status of the promotion. When creating a new promotion, this value must be set to either DRAFT or SCHEDULED. Note that you must set this value to SCHEDULED when you update a RUNNING promotion. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/marketing/types/PromotionStatusEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
