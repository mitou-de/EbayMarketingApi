...
class CampaignPagedCollection implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'campaigns' => '\EbayMarketingApi\Model\Campaign[]',
        'href' => 'string',
        'limit' => 'int',
        'next' => 'string',
        'offset' => 'int',
     ...
     * Gets campaigns
     *
     * @return \EbayMarketingApi\Model\Campaign[]|null
     */
     ...
     * Sets campaigns
     *
     * @param \EbayMarketingApi\Model\Campaign[]|null $campaigns A list of campaigns contained on this page from the paginated response.
     *
     * @return $this
     */
