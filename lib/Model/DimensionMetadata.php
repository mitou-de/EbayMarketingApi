...
class DimensionMetadata implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'dimension_key_annotations' => '\EbayMarketingApi\Model\DimensionKeyAnnotation[]'
    ];
     ...
     * Sets data_type
     *
     * @param string|null $data_type The data type of the dimension value used to create the report. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/marketing/types/DataTypeEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     *
     * @return \EbayMarketingApi\Model\DimensionKeyAnnotation[]|null
     */
     ...
     *
     * @param \EbayMarketingApi\Model\DimensionKeyAnnotation[]|null $dimension_key_annotations An list of annotation keys associated with the specified dimension of the report.
     *
     * @return $this
     */
