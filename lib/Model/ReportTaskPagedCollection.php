...
class ReportTaskPagedCollection implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'prev' => 'string',
        'total' => 'int',
        'report_tasks' => '\EbayMarketingApi\Model\ReportTask[]'
    ];
     ...
     * Sets next
     *
     * @param string|null $next The URI for the next page of results. This value is returned only if there is an additional page of results in the result set. Max length: 2048
     *
     * @return $this
     */
     ...
     * Sets offset
     *
     * @param int|null $offset The value of the offset submitted in the request, which is the number of results to skip before listing the first returned result.
     *
     * @return $this
     */
     ...
     * Sets prev
     *
     * @param string|null $prev The URI for the previous page of results. This value is returned only if there is a previous page of results in the result set. Max length: 2048
     *
     * @return $this
     */
     ...
     * Sets total
     *
     * @param int|null $total The total number of items in the result set.
     *
     * @return $this
     */
     ...
     * Gets report_tasks
     *
     * @return \EbayMarketingApi\Model\ReportTask[]|null
     */
     ...
     * Sets report_tasks
     *
     * @param \EbayMarketingApi\Model\ReportTask[]|null $report_tasks A list of report tasks contained on this page from the paginated response.
     *
     * @return $this
     */
