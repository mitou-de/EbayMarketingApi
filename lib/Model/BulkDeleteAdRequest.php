...
class BulkDeleteAdRequest implements ModelInterface, ArrayAccess
{
     ...
     * Gets requests
     *
     * @return \EbayMarketingApi\Model\DeleteAdRequest[]|null
     */
     ...
     * Sets requests
     *
     * @param \EbayMarketingApi\Model\DeleteAdRequest[]|null $requests An array of the listing IDs that identify the ads to remove. Note: This request accepts both listing IDs, as generated by the Inventory API, and an item IDs, as used in the eBay Traditional API set (e.g., the Trading and Finding APIs).
     *
     * @return $this
     */
