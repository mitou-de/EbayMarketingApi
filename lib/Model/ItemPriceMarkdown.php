...
class ItemPriceMarkdown implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'selected_inventory_discounts' => '\EbayMarketingApi\Model\SelectedInventoryDiscount[]',
        'start_date' => 'string'
    ];
     ...
     * Sets priority
     *
     * @param string|null $priority This field is ignored in markdown promotions. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/marketing/types/PromotionPriorityEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     *
     * @param string|null $promotion_status The current status of the promotion. When creating a new promotion, you must set this value to either DRAFT or SCHEDULED. Note that you must set this value to SCHEDULED when you update a RUNNING promotion. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/marketing/types/PromotionStatusEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     *
     * @return \EbayMarketingApi\Model\SelectedInventoryDiscount[]|null
     */
     ...
     *
     * @param \EbayMarketingApi\Model\SelectedInventoryDiscount[]|null $selected_inventory_discounts A list that defines the sets of selected items for the markdown promotion and the discount specified for promotion.
     *
     * @return $this
     */
