 ...
 *
 * @category Class
 * @description This complex type defines the fields returned for a promotion.
 * @package  EbayMarketingApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ItemPromotionResponse implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param bool|null $apply_discount_to_single_item_only If set to true, the discount is applied only when the buyer purchases multiple quantities of a single item in the promotion. Otherwise, the promotional discount applies to multiple quantities of any items in the promotion. Note that this flag is not relevant if the inventoryCriterion container identifies a single listing ID for the promotion.
     *
     * @return $this
     */
     ...
     * Sets discount_rules
     *
     * @param \EbayMarketingApi\Model\DiscountRule[]|null $discount_rules A list containing the promotion benefits (discountRule) and the rules that define when the benefit is applied (discountSpecification).
     *
     * @return $this
     */
     ...
     *
     * @param string|null $promotion_status The current status of the promotion. When creating a new promotion, this value must be set to either DRAFT or SCHEDULED. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/marketing/types/PromotionStatusEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     * Sets promotion_type
     *
     * @param string|null $promotion_type Indicates the type of the promotion, either MARKDOWN_SALE, ORDER_DISCOUNT, or VOLUME_DISCOUNT. For implementation help, refer to <a href='https://developer.ebay.com/devzone/rest/api-ref/marketing/types/PromotionTypeEnum.html'>eBay API documentation</a>
     *
     * @return $this
     */
