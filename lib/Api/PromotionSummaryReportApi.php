...
class PromotionSummaryReportApi
{
     ...
     * @return \EbayMarketingApi\Model\SummaryReportResponse
     */
     ...
     * @throws \EbayMarketingApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EbayMarketingApi\Model\SummaryReportResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPromotionSummaryReportWithHttpInfo($marketplace_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EbayMarketingApi\Model\SummaryReportResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EbayMarketingApi\Model\SummaryReportResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\EbayMarketingApi\Model\SummaryReportResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EbayMarketingApi\Model\SummaryReportResponse',
