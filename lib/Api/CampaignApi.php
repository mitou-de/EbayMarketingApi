...
class CampaignApi
{
     ...
     * @param  \EbayMarketingApi\Model\CloneCampaignRequest $clone_campaign_request This type defines the fields for a clone campaign request. (required)
     *
    ...
    {
        list($response) = $this->cloneCampaignWithHttpInfo($campaign_id, $clone_campaign_request);
        return $response;
    }
     ...
     */
    protected function cloneCampaignRequest($campaign_id, $clone_campaign_request)
    {
        ...
        if ($clone_campaign_request === null || (is_array($clone_campaign_request) && count($clone_campaign_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $clone_campaign_request when calling cloneCampaign'
            );
        }
        ...
        if (isset($clone_campaign_request)) {
            $_tempBody = $clone_campaign_request;
        }
     ...
     *
     * @param  \EbayMarketingApi\Model\CreateCampaignRequest $create_campaign_request This type defines the fields for the create campaign request. (required)
     *
     * @throws \EbayMarketingApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createCampaignRequest($create_campaign_request)
    {
        ...
        if (isset($create_campaign_request)) {
            $_tempBody = $create_campaign_request;
        }
     ...
     * @throws \EbayMarketingApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EbayMarketingApi\Model\Campaigns
     */
     ...
     * @throws \EbayMarketingApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EbayMarketingApi\Model\Campaigns, HTTP status code, HTTP response headers (array of strings)
     */
    public function findCampaignByAdReferenceWithHttpInfo($inventory_reference_id = null, $inventory_reference_type = null, $listing_id = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EbayMarketingApi\Model\Campaigns' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EbayMarketingApi\Model\Campaigns', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\EbayMarketingApi\Model\Campaigns';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EbayMarketingApi\Model\Campaigns',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \EbayMarketingApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EbayMarketingApi\Model\Campaign
     */
     ...
     * @throws \EbayMarketingApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EbayMarketingApi\Model\Campaign, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCampaignWithHttpInfo($campaign_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EbayMarketingApi\Model\Campaign' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EbayMarketingApi\Model\Campaign', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\EbayMarketingApi\Model\Campaign';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EbayMarketingApi\Model\Campaign',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \EbayMarketingApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EbayMarketingApi\Model\CampaignPagedCollection
     */
     ...
     * @throws \EbayMarketingApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EbayMarketingApi\Model\CampaignPagedCollection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCampaignsWithHttpInfo($campaign_name = null, $campaign_status = null, $end_date_range = null, $limit = null, $offset = null, $start_date_range = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EbayMarketingApi\Model\CampaignPagedCollection' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EbayMarketingApi\Model\CampaignPagedCollection', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\EbayMarketingApi\Model\CampaignPagedCollection';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EbayMarketingApi\Model\CampaignPagedCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function getCampaignsRequest($campaign_name = null, $campaign_status = null, $end_date_range = null, $limit = null, $offset = null, $start_date_range = null)
    {
        ...
        if ($end_date_range !== null) {
            if('form' === 'form' && is_array($end_date_range)) {
                foreach($end_date_range as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
        ...
        if ($start_date_range !== null) {
            if('form' === 'form' && is_array($start_date_range)) {
                foreach($start_date_range as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
     ...
     *
     * @param  string $campaign_id A unique eBay-assigned ID for an ad campaign that&#39;s generated when a campaign is created. Get a seller&#39;s campaign IDs by calling getCampaigns. (required)
     * @param  \EbayMarketingApi\Model\UpdateCampaignIdentificationRequest $update_campaign_identification_request This type defines the fields to updated the campaign name and start and end dates. (required)
     *
     * @throws \EbayMarketingApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateCampaignIdentificationRequest($campaign_id, $update_campaign_identification_request)
    {
        // verify the required parameter 'campaign_id' is set
        if ($campaign_id === null || (is_array($campaign_id) && count($campaign_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($update_campaign_identification_request === null || (is_array($update_campaign_identification_request) && count($update_campaign_identification_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $update_campaign_identification_request when calling updateCampaignIdentification'
            );
        }
        ...
        if (isset($update_campaign_identification_request)) {
            $_tempBody = $update_campaign_identification_request;
        }
