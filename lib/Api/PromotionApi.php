...
class PromotionApi
{
     ...
     * @throws \EbayMarketingApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \EbayMarketingApi\Model\PromotionsPagedCollection
     */
     ...
     * @throws \EbayMarketingApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \EbayMarketingApi\Model\PromotionsPagedCollection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPromotionsWithHttpInfo($marketplace_id, $limit = null, $offset = null, $promotion_status = null, $promotion_type = null, $q = null, $sort = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\EbayMarketingApi\Model\PromotionsPagedCollection' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\EbayMarketingApi\Model\PromotionsPagedCollection', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\EbayMarketingApi\Model\PromotionsPagedCollection';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EbayMarketingApi\Model\PromotionsPagedCollection',
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPromotionsRequest($marketplace_id, $limit = null, $offset = null, $promotion_status = null, $promotion_type = null, $q = null, $sort = null)
    {
